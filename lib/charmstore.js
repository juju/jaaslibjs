...
charmstore.prototype = {
  ...
  */
  getFile: function(entityId, filename, callback) {
    ...
    const headers = null;
    return this.bakery.get(url, headers, utils._wrap(callback));
  },
  ...
  */
  getCanonicalId: function(entityId, callback) {
    ...
    return this.bakery.get(
      url, headers, utils._wrap(handler, {parseJSON: true}));
  },
  /**
  ...
  */
  whoami: function(callback) {
    ...
    const wrappedCallback =
      utils._wrap(
        utils._transformAuthObject.bind(this, callback), {parseJSON: true});
    return this.bakery.get(url, headers, wrappedCallback);
  },
  ...
  */
  getMacaroon: function(callback) {
    ...
    const headers = null;
    return this.bakery.get(
      url, headers, utils._wrap(callback, {parseJSON: true}));
  },
  ...
  */
  setAuthCookie: function(macaroons, callback) {
    ...
    return this.bakery.put(
      url, headers, body, utils._wrap(callback, {parseJSON: true}));
  },
  ...
  */
  getAvailableVersions: function(charmId, callback) {
    ...
    const headers = null;
    const wrappedCallback = utils._wrap(
